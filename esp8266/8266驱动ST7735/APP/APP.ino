...
<body>\r\n\
  <img src='/logo.bmp' width='128' height='160' />\r\n\
  <form method='POST' action='/' enctype='multipart/form-data'>\r\n\
  <input type='file' name='update' id='update'><input type='submit' value='提交'></form>\r\n\
  文件格式必须为bmp，24位深，本示例使用的屏幕为1.8寸TFT,分辨率128*160，ic:ST7735\r\n\
</body>\r\n\
</html>";
...
Serial.print("tft.width: ");Serial.println(x);Serial.println(tft.width());
Serial.print("tft.height: ");Serial.println(y);Serial.println(tft.height());
  Serial.println();
