/*
  ...
  Please make sure esp8266 A0 pin represents the analog input configured on #define pin
...
#define pin A0  //MQ135引脚值
//设置上传速率2s（1s<=upDataTime<=60s） //下面的2代表上传间隔是2秒
...
#define ADC_Bit_Resolution 10 // For esp8266 UNO/MEGA/NANO
...
void setup() {
  ...
  /*****************************  MQ Init ********************************************/ 
  //Remarks: Configure the pin of esp8266 as input.
  /************************************************************************************/ 
  MQ135.init(); 
  /* 
  ...
  */
  ...
  for(int i = 1; i<=10; i ++)
  {
    MQ135.update(); // Update data, the esp8266 will read the voltage from the analog pin
...
void doTCPClientTick(){
  ...
  */
      ...
      */
      String upstr = "";
      upstr = "cmd=2&uid="+UID+"&topic="+TOPIC+"&msg=#"+CO+"#"+Alcohol+"#"+CO2 + 400+"#"+Toluen+"#"+NH4+"#"+Aceton+"#\r\n";
